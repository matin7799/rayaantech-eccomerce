...
<details>
<summary>Responses API version This version uses `gpt-5.5` because `kimi-k2.7-code` may not be enabled for `/v1/responses` in the current AvalAI model data.</summary>
...
response = client.responses.create(
    ...
    input="Implement a REST API in FastAPI with JWT authentication and SQLAlchemy models.",
)
...
<!-- responses-equivalent:start -->
<details>
<summary>Responses API version This version uses `gpt-5.5` because `kimi-k2.7-code-highspeed` may not be enabled for `/v1/responses` in the current AvalAI model data.</summary>
...
response = client.responses.create(
    model="gpt-5.5",
    instructions="You are a helpful assistant.",
    input="Write a debounced search hook in React with TypeScript.",
)
...
Kimi K2.6 is the previous Moonshot open-source coding model, now superseded by Kimi K2.7 Code for new agentic coding workloads. It remains useful for state-of-the-art coding, long-horizon execution, and agent swarm capabilities, building on K2.5 with stronger multi-step reliability, full-stack generation, Document-to-Skills reusability, Claw Groups (Preview), and Kimi Slides.
...
<!-- responses-equivalent:start -->
<details>
<summary>Responses API version This version uses `gpt-5.5` because `kimi-k2.6` may not be enabled for `/v1/responses` in the current AvalAI model data.</summary>
...
<!-- responses-equivalent:start -->
<details>
<summary>Responses API version This version uses `gpt-5.5` because `kimi-k2.5` may not be enabled for `/v1/responses` in the current AvalAI model data.</summary>
...
response = client.responses.create(
    model="gpt-5.5",
    instructions="You are a helpful assistant.",
    input="Create a responsive landing page with scroll-triggered animations.",
)
...
**Moonshot AI's earlier flagship agentic reasoning model with deep reasoning capabilities**

[`kimi-k2-thinking`](en/news/2025-11-18-new-models-gemini-3-pro-kimi-k2-thinking.md) is an earlier Moonshot AI flagship for general-purpose agentic reasoning, deep reasoning, and multi-step tool use. It remains useful for highly complex problems that benefit from extended reasoning chains and sequential tool calls.
...
<!-- responses-equivalent:start -->
<details>
<summary>Responses API version This version uses `gpt-5.5` because `kimi-k2-thinking` may not be enabled for `/v1/responses` in the current AvalAI model data.</summary>
...
<!-- responses-equivalent:start -->
<details>
<summary>Responses API version This version uses `gpt-5.5` because `kimi-k2-0711-preview` may not be enabled for `/v1/responses` in the current AvalAI model data.</summary>
...
response = client.responses.create(
    model="gpt-5.5",
    instructions="You are a helpful assistant.",
    input="Explain the concept of prompt caching.",
)
...
<!-- responses-equivalent:start -->
<details>
<summary>Responses API version This version uses `gpt-5.5` because `kimi-latest` may not be enabled for `/v1/responses` in the current AvalAI model data.</summary>
...
<!-- responses-equivalent:start -->
<details>
<summary>Responses API version This version uses `gpt-5.5` because `kimi-thinking-preview` may not be enabled for `/v1/responses` in the current AvalAI model data.</summary>
...
<!-- responses-equivalent:start -->
<details>
<summary>Responses API version This version uses `gpt-5.5` because `moonshot-v1-8k` may not be enabled for `/v1/responses` in the current AvalAI model data.</summary>
...
<!-- responses-equivalent:start -->
<details>
<summary>Responses API version This version uses `gpt-5.5` because `moonshot-v1-8k-vision-preview` may not be enabled for `/v1/responses` in the current AvalAI model data.</summary>
...
<!-- responses-equivalent:start -->
<details>
<summary>Responses API version This version uses `gpt-5.5` because `moonshot-v1-32k` may not be enabled for `/v1/responses` in the current AvalAI model data.</summary>
...
response = client.responses.create(
    model="gpt-5.5",
    instructions="You are a helpful assistant.",
    input="Summarize this article: [article content]",
)
...
<!-- responses-equivalent:start -->
<details>
<summary>Responses API version This version uses `gpt-5.5` because `moonshot-v1-auto` may not be enabled for `/v1/responses` in the current AvalAI model data.</summary>
...
response = client.responses.create(
    model="gpt-5.5",
    instructions="You are a helpful assistant.",
    input="Help me understand recursion in programming.",
)
...
response = client.responses.create(
    model="gpt-5.5",
    instructions="You are a helpful assistant.",
    input="My name is John, I am 30 years old, and I live in New York.",
)
