...
response = client.responses.create(
    ...
    input="Design a resilient event-driven architecture for a global payments platform.",
)
...
response = client.responses.create(
    model="gpt-5.5",
    instructions="You are a helpful assistant.",
    input="Design a comprehensive solution for optimizing a large-scale distributed system.",
)
    ...
    input=[
        {
            ...
            "content": [
                {
                    "type": "input_text",
                    "text": "Create a minimalist poster with Persian text",
                },
...
<!-- responses-equivalent:start -->
<details>
<summary>Responses API version This version uses `gpt-5.5` because `gemini-3.1-flash-image` may not be enabled for `/v1/responses` in the current AvalAI model data.</summary>
    ...
    input=[
        {
            ...
            "content": [
                {
                    "type": "input_text",
                    "text": "Create a photorealistic nano banana dish in a fancy restaurant with a Gemini theme",
                },
                {"type": "input_image", "image_url": "https://example.com/image.png"},
            ],
        }
...
<!-- responses-equivalent:start -->
<details>
<summary>Responses API version This version uses `gpt-5.5` because `gemini-3.1-flash-lite` may not be enabled for `/v1/responses` in the current AvalAI model data.</summary>
...
response = client.responses.create(
    model="gpt-5.5",
    instructions="You are a helpful assistant.",
    input="Translate the following text to German: Hey, are you down to grab some pizza later? I",
)
...
Gemini 3 Flash Preview (`gemini-3-flash-preview`) is an earlier Flash preview optimized for speed, search grounding, and multimodal work. It remains available for compatibility, but new production integrations should usually start with `gemini-3.5-flash` or the stable `gemini-3.1-flash-lite` alias when cost efficiency is the priority.
...
<!-- responses-equivalent:start -->
<details>
<summary>Responses API version This version uses `gpt-5.5` because `gemini-3-flash-preview` may not be enabled for `/v1/responses` in the current AvalAI model data.</summary>
...
<!-- responses-equivalent:start -->
<details>
<summary>Responses API version This version uses `gpt-5.5` because `gemini-2.5-pro` may not be enabled for `/v1/responses` in the current AvalAI model data.</summary>
...
response = client.responses.create(
    model="gpt-5.5",
    instructions="You are a helpful assistant.",
    input="Summarize the key principles of machine learning in a concise way.",
)
...
<!-- responses-equivalent:start -->
<details>
<summary>Responses API version This version uses `gpt-5.5` because `gemini-flash-latest` may not be enabled for `/v1/responses` in the current AvalAI model data.</summary>
...
response = client.responses.create(
    model="gpt-5.5",
    instructions="You are a helpful assistant.",
    input="Analyze this complex scenario and provide detailed reasoning.",
)
...
<!-- responses-equivalent:start -->
<details>
<summary>Responses API version This version uses `gpt-5.5` because `gemini-2.5-flash-preview-09-2025` may not be enabled for `/v1/responses` in the current AvalAI model data.</summary>
...
<!-- responses-equivalent:start -->
<details>
<summary>Responses API version This version uses `gpt-5.5` because `gemini-flash-lite-latest` may not be enabled for `/v1/responses` in the current AvalAI model data.</summary>
...
response = client.responses.create(
    model="gpt-5.5",
    instructions="You are a helpful assistant.",
    input="Process this text efficiently with cost optimization.",
)
...
<!-- responses-equivalent:start -->
<details>
<summary>Responses API version This version uses `gpt-5.5` because `gemini-2.5-flash-lite-preview-09-2025` may not be enabled for `/v1/responses` in the current AvalAI model data.</summary>
    ...
    input=[
        {
            "role": "user",
            "content": [
                {"type": "input_text", "text": "Summarize this document efficiently."},
    ...
    input=[
        {
            ...
            "content": [
                {
                    "type": "input_text",
                    "text": "A strange character on a colorful galaxy background, with lots of stars and planets.",
                },
                {"type": "input_image", "image_url": "https://example.com/image.png"},
            ],
        }
...
response = client.responses.create(
    model="gpt-5.5",
    input="Analyze the sentiment expressed in this audio file and summarize the key points.",
)
...
| High-quality chat / Content Gen   | Gemini 3.5 Flash              | Claude Sonnet 4.6, GPT-5.5 |
...
<!-- responses-equivalent:start -->
<details>
<summary>Responses API version This version uses `gpt-5.5` because `gemma-4-26b-a4b-it` may not be enabled for `/v1/responses` in the current AvalAI model data.</summary>
...
response = client.responses.create(
    model="gpt-5.5",
    instructions="You are a helpful assistant.",
    input="Explain the advantages of MoE architecture in LLMs",
)
...
<!-- responses-equivalent:start -->
<details>
<summary>Responses API version This version uses `gpt-5.5` because `gemma-4-31b-it` may not be enabled for `/v1/responses` in the current AvalAI model data.</summary>
...
response = client.responses.create(
    model="gpt-5.5",
    instructions="You are a helpful assistant.",
    input="Design a comprehensive solution for optimizing a distributed system",
)
...
<!-- responses-equivalent:start -->
<details>
<summary>Responses API version This version uses `gpt-5.5` because `gemma-3-1b-it` may not be enabled for `/v1/responses` in the current AvalAI model data.</summary>
...
<!-- responses-equivalent:start -->
<details>
<summary>Responses API version This version uses `gpt-5.5` because `gemma-3-4b-it` may not be enabled for `/v1/responses` in the current AvalAI model data.</summary>
