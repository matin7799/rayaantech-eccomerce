...
response = client.responses.create(
    ...
    input="Refactor this multi-file Python project to improve maintainability and add proper error handling.",
)
...
<!-- responses-equivalent:start -->
<details>
<summary>Responses API version This version uses `gpt-5.5` because `claude-opus-4-8` may not be enabled for `/v1/responses` in the current AvalAI model data.</summary>
...
response = client.responses.create(
    model="gpt-5.5",
    instructions="You are a helpful assistant.",
    input="Plan and execute a migration of this monorepo to a shared error-handling middleware across all services.",
)
...
<!-- responses-equivalent:start -->
<details>
<summary>Responses API version This version uses `gpt-5.5` because `claude-opus-4-7` may not be enabled for `/v1/responses` in the current AvalAI model data.</summary>
...
response = client.responses.create(
    model="gpt-5.5",
    instructions="You are a helpful assistant.",
    input="Analyze this multi-file application and suggest architectural improvements for better maintainability.",
)
...
<!-- responses-equivalent:start -->
<details>
<summary>Responses API version This version uses `gpt-5.5` because `claude-opus-4-6` may not be enabled for `/v1/responses` in the current AvalAI model data.</summary>
...
response = client.responses.create(
    model="gpt-5.5",
    instructions="You are a helpful assistant.",
    input="Review this codebase and suggest improvements for better maintainability.",
)
...
<!-- responses-equivalent:start -->
<details>
<summary>Responses API version This version uses `gpt-5.5` because `claude-sonnet-4-5` may not be enabled for `/v1/responses` in the current AvalAI model data.</summary>
...
response = client.responses.create(
    model="gpt-5.5",
    instructions="You are a helpful assistant.",
    input="Refactor this multi-file Python project for better maintainability and add proper error handling.",
)
...
response = client.responses.create(
    model="gpt-5.5",
    instructions="You are a helpful assistant.",
    input="List the top 3 programming languages with their key features.",
)
...
response = client.responses.create(
    model="gpt-5.5",
    instructions="You are a helpful assistant.",
    input="Can you help me improve this paragraph:",
)
