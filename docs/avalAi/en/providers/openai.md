...
response = client.responses.create(
    ...
    input="Refactor this function into an idiomatic async version and explain the trade-offs.",
)
...
response = client.responses.create(
    model="gpt-5.4",
    instructions="You are a helpful assistant.",
    input="Design an algorithm to optimize route planning for a delivery service.",
)
...
response = client.responses.create(
    model="gpt-5.1-chat",
    instructions="You are a helpful assistant.",
    input="Explain the key differences between microservices and monolithic architecture.",
)
...
response = client.responses.create(
    model="gpt-5-mini",
    instructions="You are a helpful assistant.",
    input="Optimize this Python function for better performance and readability.",
)
...
response = client.responses.create(
    model="gpt-5-nano",
    instructions="You are a helpful assistant.",
    input="Classify this customer feedback as positive, negative, or neutral:",
)
...
response = client.responses.create(
    ...
    instructions="You are a helpful assistant.",
    input="Explain quantum computing concepts in simple terms.",
)
...
response = client.responses.create(
    model="gpt-5-codex",
    instructions="You are a helpful assistant.",
    input="Create a complete Python class for a binary search tree with insert, search, delete, and traversal methods.",
)
...
response = client.responses.create(
    model="gpt-5.1-codex-max",
    instructions="You are a helpful assistant.",
    input="Create a complete distributed task queue system with worker management, task prioritization, and failure recovery.",
)
...
response = client.responses.create(
    model="o3-pro",
    instructions="You are a helpful assistant.",
    input="Analyze this complex mathematical proof and provide detailed improvements.",
)
...
response = client.responses.create(
    model="o3",
    instructions="You are a helpful assistant.",
    input="Analyze this mathematical proof and identify any errors or improvements.",
)
...
<!-- responses-equivalent:start -->
<details>
<summary>Responses API version This version uses `gpt-5.5` because `o4-mini` may not be enabled for `/v1/responses` in the current AvalAI model data.</summary>
...
<!-- responses-equivalent:start -->
<details>
<summary>Responses API version This version uses `gpt-5.5` because `gpt-4o` may not be enabled for `/v1/responses` in the current AvalAI model data.</summary>
...
response = client.responses.create(
    model="gpt-4.1",
    instructions="You are a helpful assistant.",
    input="Analyze the implications of recent advances in quantum computing.",
)
...
response = client.responses.create(
    model="gpt-4.1-mini",
    instructions="You are a helpful assistant.",
    input="Provide a summary of the latest climate change research.",
)
...
response = client.responses.create(
    model="gpt-4.1-nano",
    instructions="You are a helpful assistant.",
    input="Write a short blog post about sustainable living.",
)
...
<!-- responses-equivalent:start -->
<details>
<summary>Responses API version This version uses `gpt-5.5` because `gpt-4o-mini-search-preview` may not be enabled for `/v1/responses` in the current AvalAI model data.</summary>
...
<!-- responses-equivalent:start -->
<details>
<summary>Responses API version This version uses `gpt-5.5` because `o1` may not be enabled for `/v1/responses` in the current AvalAI model data.</summary>
...
response = client.responses.create(
    model="gpt-5.5",
    instructions="You are a helpful assistant.",
    input="Analyze the logical structure of this argument and identify any fallacies.",
)
...
<!-- responses-equivalent:start -->
<details>
<summary>Responses API version This version uses `gpt-5.5` because `o1-mini` may not be enabled for `/v1/responses` in the current AvalAI model data.</summary>
...
response = client.responses.create(
    model="gpt-5.5",
    instructions="You are a helpful assistant.",
    input="Break down the steps needed to organize a large conference.",
)
...
<!-- responses-equivalent:start -->
<details>
<summary>Responses API version This version uses `gpt-5.5` because `gpt-3.5-turbo` may not be enabled for `/v1/responses` in the current AvalAI model data.</summary>
...
response = client.responses.create(
    model="gpt-5.5",
    instructions="You are a helpful assistant.",
    input="Summarize the key features of machine learning.",
)
...
<!-- responses-equivalent:start -->
<details>
<summary>Responses API version This version uses `gpt-5.5` because `gpt-oss-120b` may not be enabled for `/v1/responses` in the current AvalAI model data.</summary>
...
response = client.responses.create(
    model="gpt-5.5",
    instructions="You are a helpful assistant.",
    input="Analyze this complex algorithmic problem and provide a step-by-step solution.",
)
...
<!-- responses-equivalent:start -->
<details>
<summary>Responses API version This version uses `gpt-5.5` because `openai.gpt-oss-120b-1:0` may not be enabled for `/v1/responses` in the current AvalAI model data.</summary>
...
response = client.responses.create(
    model="gpt-5.5",
    instructions="You are a helpful assistant.",
    input="Conduct a thorough analysis of the given research paper and identify key insights.",
)
...
<!-- responses-equivalent:start -->
<details>
<summary>Responses API version This version uses `gpt-5.5` because `openai.gpt-oss-20b-1:0` may not be enabled for `/v1/responses` in the current AvalAI model data.</summary>
    ...
    input=[
        {
            ...
            "content": [
                {
                    "type": "input_text",
                    "text": "Summarize this document and extract the key action items.",
                },
...
Use `gpt-audio` for a Responses-compatible text-first migration path, because `gpt-audio-1.5` is currently documented here as a Chat Completions audio model.
...
- `messages` → `input`
- `choices[0].message.content` → `response.output_text`
- keep Chat Completions for audio output when the target model exposes only `/v1/chat/completions`
...
Use this version when you want the same prompt through `/v1/responses`.
...
- `messages` → `input`
- `choices[0].message.content` → `response.output_text`
- inspect `response.output` for non-text response items
...
Use Responses for text, reasoning, and tool-capable OpenAI models while keeping Images API calls for direct image generation.
