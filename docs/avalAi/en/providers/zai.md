...
<details>
<summary>Responses API version This version uses `gpt-5.5` because `glm-5.2` may not be enabled for `/v1/responses` in the current AvalAI model data.</summary>
...
response = client.responses.create(
    ...
    input="Refactor this large multi-file codebase to introduce a caching layer and explain the migration plan.",
)
...
<!-- responses-equivalent:start -->
<details>
<summary>Responses API version This version uses `gpt-5.5` because `glm-5.1` may not be enabled for `/v1/responses` in the current AvalAI model data.</summary>
...
response = client.responses.create(
    model="gpt-5.5",
    instructions="You are a helpful assistant.",
    input="Implement a high-performance vector database with IVF clustering and u8 prescoring for approximate nearest neighbor search.",
)
...
<!-- responses-equivalent:start -->
<details>
<summary>Responses API version This version uses `gpt-5.5` because `glm-5v-turbo` may not be enabled for `/v1/responses` in the current AvalAI model data.</summary>
...
<!-- responses-equivalent:start -->
<details>
<summary>Responses API version This version uses `gpt-5.5` because `glm-5` may not be enabled for `/v1/responses` in the current AvalAI model data.</summary>
...
response = client.responses.create(
    model="gpt-5.5",
    instructions="You are a helpful assistant.",
    input="Design and implement a microservices architecture for an e-commerce platform with order management, inventory, and payment services.",
)
...
response = client.responses.create(
    model="gpt-5.5",
    instructions="You are a helpful assistant.",
    input="Analyze this complex codebase and suggest architectural improvements for better maintainability and scalability.",
)
...
<!-- responses-equivalent:start -->
<details>
<summary>Responses API version This version uses `gpt-5.5` because `glm-5-turbo` may not be enabled for `/v1/responses` in the current AvalAI model data.</summary>
...
response = client.responses.create(
    model="gpt-5.5",
    instructions="You are a helpful assistant.",
    input="Design a research agent harness that supports data pipelines, training environments, and cross-team collaboration.",
)
...
<!-- responses-equivalent:start -->
<details>
<summary>Responses API version This version uses `gpt-5.5` because `glm-4.7` may not be enabled for `/v1/responses` in the current AvalAI model data.</summary>
...
response = client.responses.create(
    model="gpt-5.5",
    instructions="You are a helpful assistant.",
    input="Implement a binary search tree with AVL balancing in Python, including insert, delete, and search operations.",
)
...
response = client.responses.create(
    model="gpt-5.5",
    instructions="You are a helpful assistant.",
    input="Solve this IMO problem: Find all positive integers n such that n^2 + 1 is divisible by n^3 + n + 1",
)
...
<!-- responses-equivalent:start -->
<details>
<summary>Responses API version This version uses `gpt-5.5` because `glm-4.7-flashx` may not be enabled for `/v1/responses` in the current AvalAI model data.</summary>
...
response = client.responses.create(
    model="gpt-5.5",
    instructions="You are a helpful assistant.",
    input="Write a TypeScript function that implements a debounce utility with proper typing.",
)
...
<!-- responses-equivalent:start -->
<details>
<summary>Responses API version This version uses `gpt-5.5` because `glm-4.7-flash` may not be enabled for `/v1/responses` in the current AvalAI model data.</summary>
...
response = client.responses.create(
    model="gpt-5.5",
    instructions="You are a helpful assistant.",
    input="Create a modern, responsive landing page for a SaaS product with a hero section and pricing table.",
)
...
<!-- responses-equivalent:start -->
<details>
<summary>Responses API version This version uses `gpt-5.5` because `glm-4.6` may not be enabled for `/v1/responses` in the current AvalAI model data.</summary>
...
response = client.responses.create(
    model="gpt-5.5",
    instructions="You are a helpful assistant.",
    input="Create a responsive navigation bar with dropdown menus using React and Tailwind CSS.",
)
