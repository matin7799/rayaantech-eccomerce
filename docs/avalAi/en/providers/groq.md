...
<details>
<summary>Responses API version This version uses `gpt-5.5` because `groq.llama-guard-4-12b` may not be enabled for `/v1/responses` in the current AvalAI model data.</summary>
...
response = client.responses.create(
    ...
    input="Check if this content is safe: [content to moderate]",
)
...
<!-- responses-equivalent:start -->
<details>
<summary>Responses API version This version uses `gpt-5.5` because `groq.llama-4-maverick-17b-128e-instruct` may not be enabled for `/v1/responses` in the current AvalAI model data.</summary>
