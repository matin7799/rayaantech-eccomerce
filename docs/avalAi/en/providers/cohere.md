...
<details>
<summary>Responses API version This version uses `gpt-5.5` because `command-r-plus` may not be enabled for `/v1/responses` in the current AvalAI model data.</summary>
...
<!-- responses-equivalent:start -->
<details>
<summary>Responses API version This version uses `gpt-5.5` because `command-r` may not be enabled for `/v1/responses` in the current AvalAI model data.</summary>
...
<!-- responses-equivalent:start -->
<details>
<summary>Responses API version This version uses `gpt-5.5` because `cohere.command-r-plus` may not be enabled for `/v1/responses` in the current AvalAI model data.</summary>
