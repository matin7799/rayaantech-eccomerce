...
<details>
<summary>Responses API version This version uses `gpt-5.5` because `nvidia_nim.llama-3.3-nemotron-super-49b-v1.5` may not be enabled for `/v1/responses` in the current AvalAI model data.</summary>
...
<!-- responses-equivalent:start -->
<details>
<summary>Responses API version This version uses `gpt-5.5` because `nvidia_nim.nemotron-nano-12b-v2-vl` may not be enabled for `/v1/responses` in the current AvalAI model data.</summary>
