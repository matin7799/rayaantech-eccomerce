...
<details>
<summary>Responses API version This version uses `gpt-5.5` because `minimax-m3` may not be enabled for `/v1/responses` in the current AvalAI model data.</summary>
...
response = client.responses.create(
    ...
    input="Refactor this Python function for better performance and explain your reasoning.",
)
...
<!-- responses-equivalent:start -->
<details>
<summary>Responses API version This version uses `gpt-5.5` because `minimax-m2.1` may not be enabled for `/v1/responses` in the current AvalAI model data.</summary>
...
response = client.responses.create(
    model="gpt-5.5",
    instructions="You are a helpful assistant.",
    input="Implement a concurrent web crawler in Rust with rate limiting.",
)
...
<!-- responses-equivalent:start -->
<details>
<summary>Responses API version This version uses `gpt-5.5` because `minimax-m2.1-lightning` may not be enabled for `/v1/responses` in the current AvalAI model data.</summary>
...
response = client.responses.create(
    model="gpt-5.5",
    instructions="You are a helpful assistant.",
    input="Explain the difference between async/await and Promises in JavaScript.",
)
...
The `minimax-m2.5` model is an earlier MiniMax flagship designed for real-world productivity with SOTA performance in coding, agentic tool use, and office work tasks.
...
response = client.responses.create(
    model="gpt-5.5",
    instructions="You are a helpful assistant.",
    input="Implement a rate-limited concurrent web crawler in Rust with proper error handling.",
)
...
<!-- responses-equivalent:start -->
<details>
<summary>Responses API version This version uses `gpt-5.5` because `minimax-m2.5-lightning` may not be enabled for `/v1/responses` in the current AvalAI model data.</summary>
...
The `minimax-m2.7` model is a prior MiniMax flagship featuring revolutionary self-evolution capabilities, becoming the first model to deeply participate in its own evolution. It achieves state-of-the-art performance across coding, agentic tasks, and complex skill execution.
...
<!-- responses-equivalent:start -->
<details>
<summary>Responses API version This version uses `gpt-5.5` because `minimax-m2.7` may not be enabled for `/v1/responses` in the current AvalAI model data.</summary>
    ...
    input=[
        {
            ...
            "content": [
                {
                    "type": "input_text",
                    "text": "Design a microservices architecture for a real-time collaborative document editor with conflict resolution.",
                },
...
response = client.responses.create(
    model="gpt-5.5",
    instructions="You are a helpful assistant.",
    input="What are the tradeoffs between monolithic and microservices architectures?",
)
...
<!-- responses-equivalent:start -->
<details>
<summary>Responses API version This version uses `gpt-5.5` because `minimax-m2.7-highspeed` may not be enabled for `/v1/responses` in the current AvalAI model data.</summary>
...
response = client.responses.create(
    model="gpt-5.5",
    instructions="You are a helpful assistant.",
    input="Explain the CAP theorem and its implications for distributed database design.",
)
...
response = client.responses.create(
    model="gpt-5.5",
    instructions="You are a helpful assistant.",
    input="Implement a JWT authentication system in Node.js with refresh tokens",
)
