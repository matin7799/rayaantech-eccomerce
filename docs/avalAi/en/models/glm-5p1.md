...
<meta name="description" content="Explore specifications, features, pricing, and availability for the glm-5p1 AI model (unknown/unknown) on AvalAI.">
<meta name="keywords" content="AI model, glm-5p1, unknown, unknown, AvalAI, tokens, natural language processing">
  ...
  "offers": [
    {
      ...
      "priceSpecification": {
        ...
        "description": "Pricing for input tokens for the glm-5p1 AI model."
      }
    },
    {
      "@type": "Offer",
      "priceSpecification": {
        ...
        "valueAddedTaxIncluded": false,
        "description": "Pricing for output tokens for the glm-5p1 AI model."
      }
    }
  ],
  "description": "Technical details and specifications for the AI model glm-5p1.",
  "url": "https://fireworks.ai/models/fireworks/glm-5p1",
...
<tbody>
<tr><td><strong>Max Total Tokens</strong></td><td>202800</td></tr>
<tr><td><strong>Max Input Tokens</strong></td><td>202800</td></tr>
<tr><td><strong>Max Output Tokens</strong></td><td>202800</td></tr>
