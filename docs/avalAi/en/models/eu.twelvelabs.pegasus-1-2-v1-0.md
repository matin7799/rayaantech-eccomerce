...
<meta name="description" content="Explore specifications, features, pricing, and availability for the eu.twelvelabs.pegasus-1-2-v1:0 AI model (unknown/unknown) on AvalAI.">
<meta name="keywords" content="AI model, eu.twelvelabs.pegasus-1-2-v1:0, unknown, unknown, AvalAI, tokens, natural language processing">
  ...
  "offers": [
    {
      ...
      "priceSpecification": {
        ...
        "description": "Pricing for output tokens for the eu.twelvelabs.pegasus-1-2-v1:0 AI model."
      }
    }
  ],
  "description": "Technical details and specifications for the AI model eu.twelvelabs.pegasus-1-2-v1:0.",
