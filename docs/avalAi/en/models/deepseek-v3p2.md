...
<meta name="description" content="Explore specifications, features, pricing, and availability for the deepseek-v3p2 AI model (unknown/unknown) on AvalAI.">
<meta name="keywords" content="AI model, deepseek-v3p2, unknown, unknown, AvalAI, tokens, natural language processing">
  ...
  "offers": [
    {
      ...
      "priceSpecification": {
        ...
        "description": "Pricing for input tokens for the deepseek-v3p2 AI model."
      }
    },
    {
      "@type": "Offer",
      "priceSpecification": {
        ...
        "valueAddedTaxIncluded": false,
        "description": "Pricing for output tokens for the deepseek-v3p2 AI model."
      }
    }
  ],
  "description": "Technical details and specifications for the AI model deepseek-v3p2.",
  "url": "https://fireworks.ai/models/fireworks/deepseek-v3p2",
