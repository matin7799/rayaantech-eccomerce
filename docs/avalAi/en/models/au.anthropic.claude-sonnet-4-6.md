...
<meta name="description" content="Explore specifications, features, pricing, and availability for the au.anthropic.claude-sonnet-4-6 AI model (unknown/unknown) on AvalAI.">
<meta name="keywords" content="AI model, au.anthropic.claude-sonnet-4-6, unknown, unknown, AvalAI, tokens, natural language processing">
  ...
  "offers": [
    {
      ...
      "priceSpecification": {
        ...
        "description": "Pricing for input tokens for the au.anthropic.claude-sonnet-4-6 AI model."
      }
    },
    {
      "@type": "Offer",
      "priceSpecification": {
        ...
        "valueAddedTaxIncluded": false,
        "description": "Pricing for output tokens for the au.anthropic.claude-sonnet-4-6 AI model."
      }
    }
  ],
  "description": "Technical details and specifications for the AI model au.anthropic.claude-sonnet-4-6.",
