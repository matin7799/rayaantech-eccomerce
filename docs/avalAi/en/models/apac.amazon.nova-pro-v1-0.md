...
<meta name="description" content="Explore specifications, features, pricing, and availability for the apac.amazon.nova-pro-v1:0 AI model (unknown/unknown) on AvalAI.">
<meta name="keywords" content="AI model, apac.amazon.nova-pro-v1:0, unknown, unknown, AvalAI, tokens, natural language processing">
  ...
  "offers": [
    {
      ...
      "priceSpecification": {
        ...
        "description": "Pricing for input tokens for the apac.amazon.nova-pro-v1:0 AI model."
      }
    },
    {
      "@type": "Offer",
      "priceSpecification": {
        ...
        "valueAddedTaxIncluded": false,
        "description": "Pricing for output tokens for the apac.amazon.nova-pro-v1:0 AI model."
      }
    }
  ],
  "description": "Technical details and specifications for the AI model apac.amazon.nova-pro-v1:0.",
...
<tr><td><strong>Input Cost Per Token</strong></td><td>0.00000084</td></tr>
<tr><td><strong>Output Cost Per Token</strong></td><td>0.00000336</td></tr>
