...
<meta name="description" content="Explore specifications, features, pricing, and availability for the code-llama-70b AI model (unknown/unknown) on AvalAI.">
<meta name="keywords" content="AI model, code-llama-70b, unknown, unknown, AvalAI, tokens, natural language processing">
  ...
  "offers": [
    {
      ...
      "priceSpecification": {
        ...
        "description": "Pricing for input tokens for the code-llama-70b AI model."
      }
    },
    {
      "@type": "Offer",
      "priceSpecification": {
        ...
        "valueAddedTaxIncluded": false,
        "description": "Pricing for output tokens for the code-llama-70b AI model."
      }
    }
  ],
  "description": "Technical details and specifications for the AI model code-llama-70b.",
