...
<meta name="description" content="Explore specifications, features, pricing, and availability for the 5-flash-preview-0514 AI model (unknown/unknown) on AvalAI.">
<meta name="keywords" content="AI model, 5-flash-preview-0514, unknown, unknown, AvalAI, tokens, natural language processing">
  ...
  "offers": [
    {
      ...
      "priceSpecification": {
        ...
        "description": "Pricing for input tokens for the 5-flash-preview-0514 AI model."
      }
    },
    {
      "@type": "Offer",
      "priceSpecification": {
        ...
        "valueAddedTaxIncluded": false,
        "description": "Pricing for output tokens for the 5-flash-preview-0514 AI model."
      }
    }
  ],
  "description": "Technical details and specifications for the AI model 5-flash-preview-0514.",
  "url": "https://cloud.google.com/vertex-ai/generative-ai/docs/learn/models#foundation_models",
  "isAccessibleForFree": false
}
</script>

# 5-flash-preview-0514
