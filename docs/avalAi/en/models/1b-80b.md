...
<meta name="description" content="Explore specifications, features, pricing, and availability for the 1b-80b AI model (unknown/together_ai) on AvalAI.">
<meta name="keywords" content="AI model, 1b-80b, unknown, together_ai, AvalAI, tokens, natural language processing">
  ...
  "offers": [
    {
      ...
      "priceSpecification": {
        ...
        "description": "Pricing for input tokens for the 1b-80b AI model."
      }
    },
    {
      "@type": "Offer",
      "priceSpecification": {
        ...
        "valueAddedTaxIncluded": false,
        "description": "Pricing for output tokens for the 1b-80b AI model."
      }
    }
  ],
  "description": "Technical details and specifications for the AI model 1b-80b.",
  "copyrightHolder": {
    "@type": "Organization",
    "name": "together_ai"
  },
