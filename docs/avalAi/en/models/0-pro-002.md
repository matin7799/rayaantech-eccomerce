...
<meta name="description" content="Explore specifications, features, pricing, and availability for the 0-pro-002 AI model (unknown/unknown) on AvalAI.">
<meta name="keywords" content="AI model, 0-pro-002, unknown, unknown, AvalAI, tokens, natural language processing">
  ...
  "offers": [
    {
      ...
      "priceSpecification": {
        ...
        "description": "Pricing for input tokens for the 0-pro-002 AI model."
      }
    },
    {
      "@type": "Offer",
      "priceSpecification": {
        ...
        "valueAddedTaxIncluded": false,
        "description": "Pricing for output tokens for the 0-pro-002 AI model."
      }
    }
  ],
  "description": "Technical details and specifications for the AI model 0-pro-002.",
