...
<meta name="description" content="Explore specifications, features, pricing, and availability for the cogito-v1-preview-qwen-32b AI model (unknown/unknown) on AvalAI.">
<meta name="keywords" content="AI model, cogito-v1-preview-qwen-32b, unknown, unknown, AvalAI, tokens, natural language processing">
  ...
  "offers": [
    {
      ...
      "priceSpecification": {
        ...
        "description": "Pricing for input tokens for the cogito-v1-preview-qwen-32b AI model."
      }
    },
    {
      "@type": "Offer",
      "priceSpecification": {
        ...
        "valueAddedTaxIncluded": false,
        "description": "Pricing for output tokens for the cogito-v1-preview-qwen-32b AI model."
      }
    }
  ],
  "description": "Technical details and specifications for the AI model cogito-v1-preview-qwen-32b.",
