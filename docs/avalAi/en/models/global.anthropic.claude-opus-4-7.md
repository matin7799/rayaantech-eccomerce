...
<meta name="description" content="Explore specifications, features, pricing, and availability for the global.anthropic.claude-opus-4-7 AI model (unknown/unknown) on AvalAI.">
<meta name="keywords" content="AI model, global.anthropic.claude-opus-4-7, unknown, unknown, AvalAI, tokens, natural language processing">
  ...
  "offers": [
    {
      ...
      "priceSpecification": {
        ...
        "description": "Pricing for input tokens for the global.anthropic.claude-opus-4-7 AI model."
      }
    },
    {
      "@type": "Offer",
      "priceSpecification": {
        ...
        "valueAddedTaxIncluded": false,
        "description": "Pricing for output tokens for the global.anthropic.claude-opus-4-7 AI model."
      }
    }
  ],
  "description": "Technical details and specifications for the AI model global.anthropic.claude-opus-4-7.",
