...
<meta name="description" content="Explore specifications, features, pricing, and availability for the fireworks-ai-above-16b AI model (unknown/unknown) on AvalAI.">
<meta name="keywords" content="AI model, fireworks-ai-above-16b, unknown, unknown, AvalAI, tokens, natural language processing">
  ...
  "offers": [
    {
      ...
      "priceSpecification": {
        ...
        "description": "Pricing for input tokens for the fireworks-ai-above-16b AI model."
      }
    },
    {
      "@type": "Offer",
      "priceSpecification": {
        ...
        "valueAddedTaxIncluded": false,
        "description": "Pricing for output tokens for the fireworks-ai-above-16b AI model."
      }
    }
  ],
  "description": "Technical details and specifications for the AI model fireworks-ai-above-16b.",
