...
<meta name="description" content="Explore specifications, features, pricing, and availability for the claude-fable-5 AI model (unknown/anthropic) on AvalAI.">
<meta name="keywords" content="AI model, claude-fable-5, unknown, anthropic, AvalAI, tokens, natural language processing">
  ...
  "offers": [
    {
      ...
      "priceSpecification": {
        ...
        "description": "Pricing for input tokens for the claude-fable-5 AI model."
      }
    },
    {
      "@type": "Offer",
      "priceSpecification": {
        ...
        "valueAddedTaxIncluded": false,
        "description": "Pricing for output tokens for the claude-fable-5 AI model."
      }
    }
  ],
  "description": "Technical details and specifications for the AI model claude-fable-5.",
  "copyrightHolder": {
    "@type": "Organization",
    "name": "anthropic"
  },
...
<tr><td><strong>Output Cost Per Token</strong></td><td>0.00005000</td></tr>
