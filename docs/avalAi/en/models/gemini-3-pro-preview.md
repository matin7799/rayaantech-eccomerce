...
<meta name="description" content="Explore specifications, features, pricing, and availability for the gemini-3-pro-preview AI model (unknown/unknown) on AvalAI.">
<meta name="keywords" content="AI model, gemini-3-pro-preview, unknown, unknown, AvalAI, tokens, natural language processing">
  ...
  "offers": [
    {
      ...
      "priceSpecification": {
        ...
        "description": "Pricing for input tokens for the gemini-3-pro-preview AI model."
      }
    },
    {
      "@type": "Offer",
      "priceSpecification": {
        ...
        "valueAddedTaxIncluded": false,
        "description": "Pricing for output tokens for the gemini-3-pro-preview AI model."
      }
    }
  ],
  "description": "Technical details and specifications for the AI model gemini-3-pro-preview.",
