...
<meta name="description" content="Explore specifications, features, pricing, and availability for the eu.anthropic.claude-opus-4-1-20250805-v1:0 AI model (unknown/unknown) on AvalAI.">
<meta name="keywords" content="AI model, eu.anthropic.claude-opus-4-1-20250805-v1:0, unknown, unknown, AvalAI, tokens, natural language processing">
  ...
  "offers": [
    {
      ...
      "priceSpecification": {
        ...
        "description": "Pricing for input tokens for the eu.anthropic.claude-opus-4-1-20250805-v1:0 AI model."
      }
    },
    {
      "@type": "Offer",
      "priceSpecification": {
        ...
        "valueAddedTaxIncluded": false,
        "description": "Pricing for output tokens for the eu.anthropic.claude-opus-4-1-20250805-v1:0 AI model."
      }
    }
  ],
  "description": "Technical details and specifications for the AI model eu.anthropic.claude-opus-4-1-20250805-v1:0.",
