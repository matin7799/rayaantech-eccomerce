...
<meta name="description" content="Explore specifications, features, pricing, and availability for the apac.anthropic.claude-opus-4-6-v1 AI model (unknown/unknown) on AvalAI.">
<meta name="keywords" content="AI model, apac.anthropic.claude-opus-4-6-v1, unknown, unknown, AvalAI, tokens, natural language processing">
  ...
  "offers": [
    {
      ...
      "priceSpecification": {
        ...
        "description": "Pricing for input tokens for the apac.anthropic.claude-opus-4-6-v1 AI model."
      }
    },
    {
      "@type": "Offer",
      "priceSpecification": {
        ...
        "valueAddedTaxIncluded": false,
        "description": "Pricing for output tokens for the apac.anthropic.claude-opus-4-6-v1 AI model."
      }
    }
  ],
  "description": "Technical details and specifications for the AI model apac.anthropic.claude-opus-4-6-v1.",
