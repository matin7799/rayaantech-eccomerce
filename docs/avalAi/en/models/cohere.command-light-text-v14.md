...
<meta name="description" content="Explore specifications, features, pricing, and availability for the cohere.command-light-text-v14 AI model (unknown/unknown) on AvalAI.">
<meta name="keywords" content="AI model, cohere.command-light-text-v14, unknown, unknown, AvalAI, tokens, natural language processing">
...
<script type="application/ld+json">
{
  ...
  "description": "Technical details and specifications for the AI model cohere.command-light-text-v14.",
