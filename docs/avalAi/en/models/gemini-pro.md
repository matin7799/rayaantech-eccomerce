...
<meta name="description" content="Explore specifications, features, pricing, and availability for the gemini-pro AI model (unknown/unknown) on AvalAI.">
<meta name="keywords" content="AI model, gemini-pro, unknown, unknown, AvalAI, tokens, natural language processing">
  ...
  "offers": [
    {
      ...
      "priceSpecification": {
        ...
        "description": "Pricing for input tokens for the gemini-pro AI model."
      }
    },
    {
      "@type": "Offer",
      "priceSpecification": {
        ...
        "valueAddedTaxIncluded": false,
        "description": "Pricing for output tokens for the gemini-pro AI model."
      }
    }
  ],
  "description": "Technical details and specifications for the AI model gemini-pro.",
