...
<meta name="description" content="Explore specifications, features, pricing, and availability for the fare-20b AI model (unknown/unknown) on AvalAI.">
<meta name="keywords" content="AI model, fare-20b, unknown, unknown, AvalAI, tokens, natural language processing">
  ...
  "offers": [
    {
      ...
      "priceSpecification": {
        ...
        "description": "Pricing for input tokens for the fare-20b AI model."
      }
    },
    {
      "@type": "Offer",
      "priceSpecification": {
        ...
        "valueAddedTaxIncluded": false,
        "description": "Pricing for output tokens for the fare-20b AI model."
      }
    }
  ],
  "description": "Technical details and specifications for the AI model fare-20b.",
