...
<meta name="description" content="Explore specifications, features, pricing, and availability for the glm-4p7 AI model (unknown/unknown) on AvalAI.">
<meta name="keywords" content="AI model, glm-4p7, unknown, unknown, AvalAI, tokens, natural language processing">
  ...
  "offers": [
    {
      ...
      "priceSpecification": {
        ...
        "description": "Pricing for input tokens for the glm-4p7 AI model."
      }
    },
    {
      "@type": "Offer",
      "priceSpecification": {
        ...
        "valueAddedTaxIncluded": false,
        "description": "Pricing for output tokens for the glm-4p7 AI model."
      }
    }
  ],
  "description": "Technical details and specifications for the AI model glm-4p7.",
