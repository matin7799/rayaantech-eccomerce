...
<meta name="description" content="Explore specifications, features, pricing, and availability for the 1b-to-80b AI model (unknown/unknown) on AvalAI.">
<meta name="keywords" content="AI model, 1b-to-80b, unknown, unknown, AvalAI, tokens, natural language processing">
  ...
  "offers": [
    {
      ...
      "priceSpecification": {
        ...
        "description": "Pricing for input tokens for the 1b-to-80b AI model."
      }
    },
    {
      "@type": "Offer",
      "priceSpecification": {
        ...
        "valueAddedTaxIncluded": false,
        "description": "Pricing for output tokens for the 1b-to-80b AI model."
      }
    }
  ],
  "description": "Technical details and specifications for the AI model 1b-to-80b.",
