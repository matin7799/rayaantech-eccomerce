# Generate and Edit Images with Gemini 2.5 Flash Image (Nano Banana)

## Introduction

Gemini 2.5 Flash Image or Nano Banana is Google's stable state-of-the-art image generation and editing model that combines advanced multimodal understanding with cutting-edge image generation capabilities. This guide will walk you through how to use Gemini 2.5 Flash Image through AvalAI's API to generate, edit, and transform images with natural language.

> **Note:** The stable version (`gemini-2.5-flash-image`) replaces the preview version (`gemini-2.5-flash-image-preview`). All code examples use the stable model identifier.

> This model was previously known by the code name "nano-banana" and has been highly rated for its superior image generation and editing capabilities on various AI benchmarks.
