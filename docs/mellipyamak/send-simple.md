برای ارسال پیامک به یک گیرنده از این متد استفاده کنید.

 آدرس API
POST
https://console.melipayamak.com/api/send/simple/f2610549d0e844fabadf4151dc11bd8c
پارامترهای ارسالی
{ 
  "from": "5000xxx", 
  "to": "09123456789", 
...
const options = {
    ...
    port: 443,
    path: '/api/send/simple/f2610549d0e844fabadf4151dc11bd8c',
    method: 'POST',
    headers: {
